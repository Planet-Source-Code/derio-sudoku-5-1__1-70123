...
Public Event CaptionChange(ByVal LastCaption As String)
...
Dim LastCaption As String
  ...
  IsChange = (vNewValue <> vCaption)
  LastCaption = vCaption
  vCaption = vNewValue
  UserControl.lblNumber(0).Caption = vCaption
  UserControl.lblNumber(1).Caption = vCaption
  Me.ClearNote
  PropertyChanged "Caption"
  If IsChange Then RaiseEvent CaptionChange(LastCaption)
End Property
